...
class OkxViewBody extends StatefulWidget {
  const OkxViewBody({Key? key}) : super(key: key);

  @override
  State<OkxViewBody> createState() => _OkxViewBodyState();
}

class _OkxViewBodyState extends State<OkxViewBody> {
  bool isTrue = false;
  @override
