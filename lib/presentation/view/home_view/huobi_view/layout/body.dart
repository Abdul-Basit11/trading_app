...
class HuobiViewBody extends StatefulWidget {
  const HuobiViewBody({Key? key}) : super(key: key);

  @override
  State<HuobiViewBody> createState() => _HuobiViewBodyState();
}

class _HuobiViewBodyState extends State<HuobiViewBody> {
  bool isTrue = false;
  @override
